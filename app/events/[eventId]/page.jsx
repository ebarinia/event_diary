            ...
            <div className="ml-4">
                <p className="text-3xl font-extrabold justify-center text-gray-400">{selectedEvent.name}</p>
                    ...
                    <div className="flex mt-5">
                        <Link href={selectedEvent.url} target="blank" className="bg-orange-500 hover:bg-orange-600 transition text-white font-bold py-2 px-4 rounded">Book</Link>
                        <Link href='*'><svg xmlns="http://www.w3.org/2000/svg" fill={selectedEvent.favourite ? "red" : "white"}  viewBox="0 0 24 24" strokeWidth={1.5} stroke="black" className="ml-3 w-10 h-10">
